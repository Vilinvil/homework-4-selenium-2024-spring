...
class CatalogLocators:
    ...
    UPDATE_PERIOD_SPAN = (By.XPATH, '(//span[@class="vkuiTypography vkuiTypography--normalize vkuiTypography--weight-3 vkuiInfoRow vkuiHeadline--sizeY-compact vkuiHeadline--level-1"])[2]')
    ...
    def INFO_FIELD(i):
        return (By.XPATH, 
                f"(//span[@class='vkuiTypography vkuiTypography--normalize vkuiTypography--weight-3 vkuiInfoRow vkuiHeadline--sizeY-none vkuiHeadline--level-1'])[{i}]")
